const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./HomePage-DFyrwZNZ.js","./LoadingSpinner.vue_vue_type_script_setup_true_lang-BGG7VSfd.js","./DashboardPage-R8n_ItfV.js","./ErrorMessage.vue_vue_type_script_setup_true_lang-DfzIRCNA.js","./ProjectPage-BH9ysF61.js","./draft-CU4AYu-k.js","./DraftReviewPage-DpWzE94X.js","./SprintPage-C9pg_Tcw.js"])))=>i.map(i=>d[i]);
/**
* @vue/shared v3.5.39
...
const _hoisted_1$2 = { class: "w-52 flex-shrink-0 bg-slate-900 flex flex-col h-full" };
const _hoisted_2$2 = { class: "flex-1 px-2 space-y-0.5" };
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const IconDashboard = () => h("svg", { viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" }, [
    ...
    const IconAI = () => h("svg", { viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" }, [
      h("path", {
    ...
    const IconSettings = () => h("svg", { viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" }, [
      h("path", {
        "fill-rule": "evenodd",
    ...
    const IconHome = () => h("svg", { viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" }, [
    ...
    const IconSprint = () => h("svg", { viewBox: "0 0 16 16", fill: "currentColor", "aria-hidden": "true" }, [
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("nav", _hoisted_1$2, [
        _cache[0] || (_cache[0] = createStaticVNode('<div class="px-4 pt-5 pb-4 flex items-center gap-2.5"><div class="w-7 h-7 rounded-lg bg-indigo-500 flex items-center justify-center flex-shrink-0"><svg width="14" height="14" viewBox="0 0 14 14" fill="none"><rect x="1" y="1" width="5" height="5" rx="1" fill="white"></rect><rect x="8" y="1" width="5" height="5" rx="1" fill="white" opacity="0.6"></rect><rect x="1" y="8" width="5" height="5" rx="1" fill="white" opacity="0.6"></rect><rect x="8" y="8" width="5" height="5" rx="1" fill="white"></rect></svg></div><span class="text-sm font-semibold text-white tracking-tight">QADash</span></div>', 1)),
          ...
          (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
            return createVNode(_component_RouterLink, {
              ...
              class: normalizeClass([
                ...
                isActive(item.to) ? "bg-indigo-600 text-white" : "text-slate-400 hover:text-slate-200 hover:bg-slate-800"
              ])
            }, {
              default: withCtx(() => [
                (openBlock(), createBlock(resolveDynamicComponent(item.icon), { class: "w-4 h-4 flex-shrink-0" })),
        ...
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "px-4 py-3 border-t border-slate-800" }, [
          createBaseVNode("span", { class: "text-xs text-slate-600" }, "v0.1.0-alpha")
        ], -1))
      ]);
    };
  }
});
const useProjectsStore = /* @__PURE__ */ defineStore("projects", {
  state: () => ({
    projects: [],
    loading: false,
    error: null
  ...
  getters: {
    getById: (state) => (id) => state.projects.find((p2) => p2.id === id)
  },
  actions: {
    async fetchProjects() {
      this.loading = true;
    ...
    async removeProject(id) {
      ...
      try {
        ...
        this.projects = this.projects.filter((p2) => p2.id !== id);
      } catch (e) {
        this.error = e.message;
        throw e;
      } finally {
    ...
    async updateConfig(id, patch) {
      ...
      try {
        ...
        const idx = this.projects.findIndex((p2) => p2.id === id);
        if (idx !== -1) {
...
const useTasksStore = /* @__PURE__ */ defineStore("tasks", {
  ...
  getters: {
    getUntracked: (state) => (projectId) => state.byProject[projectId]?.untracked ?? [],
    getLinked: (state) => (projectId) => state.byProject[projectId]?.linked ?? [],
    untrackedCount: (state) => (projectId) => state.byProject[projectId]?.untracked.filter((t) => !t.isIgnoredToday).length ?? 0
  },
  actions: {
    ...
    async ignoreTask(taskId, projectId) {
      this.error = null;
      try {
    ...
    async unignoreTask(taskId, projectId) {
      this.error = null;
      try {
    ...
    async toggleTask(taskId, projectId, checked) {
      const result = this.byProject[projectId];
      if (!result) return;
      const task = result.untracked.find((t) => t.id === taskId) ?? result.linked.find((t) => t.id === taskId);
      if (!task) return;
...
const useJiraStore = /* @__PURE__ */ defineStore("jira", {
  state: () => ({
    tickets: {},
    loading: false,
    error: null
  ...
  getters: {
    getTicket: (state) => (key) => state.tickets[key],
  ...
  actions: {
    ...
    async setJiraSettings(projectId, settings) {
      this.loading = true;
      this.error = null;
      try {
...
const _hoisted_1$1 = { class: "flex flex-col h-full bg-white" };
const _hoisted_2$1 = { class: "flex items-center justify-end px-4 py-1.5 border-b border-slate-100" };
...
const _hoisted_6 = { class: "bg-slate-50 border border-slate-200 rounded-2xl rounded-tl-sm px-4 py-3 min-w-[60px]" };
const _hoisted_7 = {
  key: 0,
...
const _hoisted_8 = {
  key: 1,
  class: "text-sm text-slate-700 whitespace-pre-wrap break-words font-sans leading-relaxed"
};
const _hoisted_9 = {
  key: 0,
...
const _hoisted_11 = { class: "bg-slate-800 text-white rounded-2xl rounded-tr-sm px-4 py-3" };
const _hoisted_12 = { class: "text-sm whitespace-pre-wrap break-words leading-relaxed" };
const _hoisted_13 = {
  key: 0,
  class: "mx-6 mb-2 text-xs text-red-600 bg-red-50 border border-red-200 rounded-lg px-3 py-2"
};
const _hoisted_14 = { class: "px-6 pb-5 pt-2 border-t border-slate-100" };
const _hoisted_15 = {
  key: 0,
...
const _hoisted_18 = { class: "text-xs text-slate-500 flex-1 truncate" };
const _hoisted_19 = { class: "flex gap-2 items-end" };
const _hoisted_20 = ["onKeydown"];
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  __name: "AITerminalPanel",
  props: {
    pageLabel: {},
    pagePath: {}
  },
  setup(__props) {
    ...
    const streamError = /* @__PURE__ */ ref(null);
    const userPrompt = /* @__PURE__ */ ref("");
    const chatRef = /* @__PURE__ */ ref(null);
    const inputRef = /* @__PURE__ */ ref(null);
    const attachedImage = /* @__PURE__ */ ref("");
    const attachedImageName = /* @__PURE__ */ ref("");
    const cleanups = [];
    ...
    async function startMyDay() {
      ...
      const context = {
        ...
        allScanResults: projectsStore.projects.map((p2) => ({
          projectId: p2.id,
          untracked: tasksStore.getUntracked(p2.id),
          linked: tasksStore.getLinked(p2.id)
        })),
...
📎 ${attachedImageName.value}` : "");
      ...
      try {
        await window.qaApi.ask(fullPrompt, image || void 0);
      } catch (e) {
        streamError.value = e.message;
        isStreaming.value = false;
      }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("button", {
            class: normalizeClass(["inline-flex items-center gap-1.5 text-xs font-medium px-2.5 py-1 rounded-md border transition-all", isStreaming.value ? "border-slate-100 text-slate-300 cursor-not-allowed" : "border-slate-200 bg-white text-slate-600 hover:bg-slate-50"]),
            disabled: isStreaming.value,
            onClick: startMyDay
          }, [
            (openBlock(), createElementBlock("svg", {
              class: normalizeClass(["w-3 h-3", isStreaming.value ? "animate-spin" : ""]),
              viewBox: "0 0 16 16",
              fill: "currentColor"
            }, [..._cache[2] || (_cache[2] = [
        ...
        createBaseVNode("div", {
          ...
          messages.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_4$1, [..._cache[3] || (_cache[3] = [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(messages.value, (msg, i) => {
            return openBlock(), createElementBlock("div", {
              ...
              msg.role === "assistant" ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
                ...
                createBaseVNode("div", _hoisted_6, [
                  isStreaming.value && i === messages.value.length - 1 && !msg.content ? (openBlock(), createElementBlock("div", _hoisted_7, [..._cache[4] || (_cache[4] = [
                  ...
                  ])])) : (openBlock(), createElementBlock("pre", _hoisted_8, [
                    createTextVNode(toDisplayString(msg.content), 1),
                    isStreaming.value && i === messages.value.length - 1 ? (openBlock(), createElementBlock("span", _hoisted_9)) : createCommentVNode("", true)
                  ]))
                ])
              ])) : (openBlock(), createElementBlock("div", _hoisted_10, [
                createBaseVNode("div", _hoisted_11, [
                  createBaseVNode("p", _hoisted_12, toDisplayString(msg.content), 1)
                ])
              ]))
            ], 2);
          }), 128))
        ], 512),
        streamError.value ? (openBlock(), createElementBlock("div", _hoisted_13, toDisplayString(streamError.value), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_14, [
          attachedImage.value ? (openBlock(), createElementBlock("div", _hoisted_15, [
            ...
            }, null, 8, _hoisted_16)) : (openBlock(), createElementBlock("svg", _hoisted_17, [..._cache[6] || (_cache[6] = [
            ...
            createBaseVNode("span", _hoisted_18, toDisplayString(attachedImageName.value), 1),
            createBaseVNode("button", {
...
const _hoisted_1 = { class: "flex h-screen overflow-hidden bg-slate-900 select-none" };
const _hoisted_2 = { class: "flex-1 overflow-hidden flex flex-col min-w-0" };
const _hoisted_3 = { class: "flex items-center gap-2" };
const _hoisted_4 = { class: "text-[10px] text-slate-400 bg-slate-100 rounded px-1.5 py-0.5" };
const _hoisted_5 = { class: "fixed bottom-20 right-4 z-50 flex items-center gap-2" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const isDev = false;
    const terminalOpen = /* @__PURE__ */ ref(false);
    const terminalHeight = /* @__PURE__ */ ref(360);
    ...
    let cleanupDangerZone = null;
    onMounted(() => {
      cleanupSync = window.qaApi.onSyncCompleted(async (summary) => {
        await projectsStore.fetchProjects();
        await Promise.all(projectsStore.projects.map((p2) => tasksStore.scanProject(p2.id)));
      });
      cleanupDangerZone = window.qaApi.onDangerZoneTriggered((projectId) => {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createVNode(Transition, { name: "terminal-slide" }, {
          default: withCtx(() => [
            terminalOpen.value ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: "fixed bottom-0 left-52 right-0 z-40 bg-white border-t border-slate-200 shadow-2xl flex flex-col",
              style: normalizeStyle({ height: terminalHeight.value + "px" })
            }, [
              createBaseVNode("div", {
                ...
                createBaseVNode("div", _hoisted_3, [
                  _cache[2] || (_cache[2] = createBaseVNode("svg", {
                    ...
                    createBaseVNode("path", { d: "M6 9a.5.5 0 0 1 .5-.5h3a.5.5 0 0 1 0 1h-3A.5.5 0 0 1 6 9ZM3.854 4.146a.5.5 0 1 0-.708.708L4.793 6.5 3.146 8.146a.5.5 0 1 0 .708.708l2-2a.5.5 0 0 0 0-.708l-2-2Z" }),
                    createBaseVNode("path", { d: "M2 1a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H2Zm12 1a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h12Z" })
                  ], -1)),
                  _cache[3] || (_cache[3] = createBaseVNode("span", { class: "text-xs font-semibold text-slate-600" }, "AI Terminal", -1)),
                  createBaseVNode("span", _hoisted_4, toDisplayString(currentPageLabel.value), 1)
                ]),
                createBaseVNode("button", {
                  class: "text-slate-300 hover:text-slate-600 transition-colors text-sm",
                  onClick: _cache[0] || (_cache[0] = ($event) => terminalOpen.value = false)
                }, "✕")
              ], 32),
              createVNode(_sfc_main$1, {
                "page-label": currentPageLabel.value,
                "page-path": unref(route).fullPath,
                class: "flex-1 min-h-0"
              }, null, 8, ["page-label", "page-path"])
        ...
        createBaseVNode("div", _hoisted_5, [
          createBaseVNode("button", {
            class: normalizeClass(["w-8 h-8 rounded-full shadow-lg transition-all flex items-center justify-center", terminalOpen.value ? "bg-slate-800 text-white opacity-100" : "bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white opacity-60 hover:opacity-100"]),
            title: "AI Terminal",
            onClick: _cache[1] || (_cache[1] = ($event) => terminalOpen.value = !terminalOpen.value)
          }, [..._cache[4] || (_cache[4] = [
            createBaseVNode("svg", {
              class: "w-4 h-4",
              viewBox: "0 0 16 16",
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-538cc092"]]);
...
const routes = [
  {
    path: "/",
    name: "home",
    component: () => __vitePreload(() => import("./HomePage-DFyrwZNZ.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url)
  },
  {
    path: "/qa",
    name: "dashboard",
    component: () => __vitePreload(() => import("./DashboardPage-R8n_ItfV.js"), true ? __vite__mapDeps([2,1,3]) : void 0, import.meta.url),
  ...
  },
  {
    path: "/project/:id",
    name: "project",
    component: () => __vitePreload(() => import("./ProjectPage-BH9ysF61.js"), true ? __vite__mapDeps([4,5,1,3]) : void 0, import.meta.url)
  },
  {
    path: "/ai",
    name: "ai-terminal",
    component: () => __vitePreload(() => import("./AITerminalPage-XrxNYgJP.js"), true ? [] : void 0, import.meta.url)
  },
  {
    path: "/draft",
    name: "draft-review",
    component: () => __vitePreload(() => import("./DraftReviewPage-DpWzE94X.js"), true ? __vite__mapDeps([6,5,1,3]) : void 0, import.meta.url)
  },
  {
    path: "/sprint",
    name: "sprint",
    component: () => __vitePreload(() => import("./SprintPage-C9pg_Tcw.js"), true ? __vite__mapDeps([7,1]) : void 0, import.meta.url)
  },
  {
    path: "/credentials",
    name: "credentials",
    component: () => __vitePreload(() => import("./CredentialsPage-dYXtesiC.js"), true ? [] : void 0, import.meta.url)
  },
  {
    path: "/settings",
    name: "settings",
    component: () => __vitePreload(() => import("./SettingsPage-CkbiMoAS.js"), true ? [] : void 0, import.meta.url)
  }
];
