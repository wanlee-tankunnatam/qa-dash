      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("div", null, [
            _cache[6] || (_cache[6] = createBaseVNode("h1", { class: "text-base font-semibold text-slate-800" }, "Tasks", -1)),
                  ...
                  createBaseVNode("table", _hoisted_24, [
                    _cache[15] || (_cache[15] = createBaseVNode("thead", null, [
                      createBaseVNode("tr", { class: "border-b border-slate-100 text-left text-[10px] text-slate-400 uppercase tracking-wide" }, [
                        ...
                        createBaseVNode("th", { class: "px-3 pb-1.5 w-24 text-center" }, "Dev"),
                        createBaseVNode("th", { class: "px-3 pb-1.5 w-14 text-center" }, "API"),
                        createBaseVNode("th", { class: "px-3 pb-1.5 w-16 text-center" }, "Integ."),
                        ...
                        createBaseVNode("th", { class: "px-3 pb-1.5 w-20 text-right" }, "Due"),
              ...
              createBaseVNode("table", _hoisted_52, [
                _cache[21] || (_cache[21] = createBaseVNode("thead", null, [
                  createBaseVNode("tr", { class: "border-b border-slate-100 bg-white sticky top-0 z-10" }, [
                    ...
                    createBaseVNode("th", { class: "text-center px-4 py-2.5 text-xs font-semibold text-slate-500 w-24" }, "Dev"),
